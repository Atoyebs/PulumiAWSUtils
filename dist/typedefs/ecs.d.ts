...
export declare class ECSFargateCluster {
    ...
    static createRoute53SubdomainRecords(fargateResourceArray: CombinedFargateResource[], loadBalancer: awsx.lb.ApplicationLoadBalancer, hostedZoneId: string, baseDomain: string, stage?: string): {
        [key: string]: string;
    };
    static createRoute53SubdomainRecord(fargateResource: CombinedFargateResource, loadBalancer: awsx.lb.ApplicationLoadBalancer, hostedZoneId: string, baseDomain: string, stage?: string): string;
...
export type CombinedFargateResource = TargetGroupInput & ListenerRules & {
    imageName: string;
    cpuSize: number;
    memorySize: number;
    desiredCount: number;
